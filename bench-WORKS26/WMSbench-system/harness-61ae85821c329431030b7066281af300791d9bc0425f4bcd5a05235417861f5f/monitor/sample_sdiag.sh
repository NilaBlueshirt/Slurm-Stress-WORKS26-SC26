...
#
# Usage: sample_sdiag.sh PERIODIC_OUTPUT_DIR DURATION_SECONDS BENCHMARK_USER
# WMSbench_SDIAG_INTERVAL_SECONDS defaults to 300 and may never be below 300.
set -euo pipefail

OUTDIR=${1:?usage: sample_sdiag.sh PERIODIC_OUTPUT_DIR DURATION_SECONDS BENCHMARK_USER}
DURATION=${2:?usage: sample_sdiag.sh PERIODIC_OUTPUT_DIR DURATION_SECONDS BENCHMARK_USER}
BENCH_USER=${3:?usage: sample_sdiag.sh PERIODIC_OUTPUT_DIR DURATION_SECONDS BENCHMARK_USER}
