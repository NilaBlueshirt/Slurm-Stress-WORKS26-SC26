...
works26_manual_load() {
    ENV_FILE=${1:?usage: works26_manual_load CONTROLLER_ENV VENUE BLOCK_INDEX BACKEND}
    VENUE=${2:?usage: works26_manual_load CONTROLLER_ENV VENUE BLOCK_INDEX BACKEND}
    REP=${3:?usage: works26_manual_load CONTROLLER_ENV VENUE BLOCK_INDEX BACKEND}
    BACKEND=${4:?usage: works26_manual_load CONTROLLER_ENV VENUE BLOCK_INDEX BACKEND}
